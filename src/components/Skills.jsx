...
const Skills = () => {
  const [changeSkills, setChangeSkills] = useState('frontEnd')
  return (
    <div className='py-10 dark:bg-black dark:text-white' id='skills'>
      ...
      <div className='w-fit my-4 mt-9 mx-auto bg-gray-300 rounded-md py-2 dark:bg-slate-900'>
        <button 
          className={changeSkills==="frontEnd" ? 'px-5 py-1 mx-2 bg-sky-500 text-white text-lg rounded-md'
          : 'px-5 py-1 mx-2 text-lg  hover:bg-gray-200 hover:rounded-md dark:hover:bg-gray-800'} 
          onClick={() => setChangeSkills("frontEnd")}>
          Front-End
        </button>

        <button 
          className={changeSkills==="tools" ? 'px-5 py-1 mx-2 bg-sky-500 text-white text-lg rounded-md' 
          : 'px-5 py-1 mx-2 text-lg hover:bg-gray-200 hover:rounded-md dark:hover:bg-gray-800'} 
          onClick={() => setChangeSkills("tools")}>
          Tools
        </button>
      </div>
