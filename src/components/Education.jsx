        ...
        <div className='my-10'>
            <div className=' flex flex-col items-center md: md:flex-row w-fit my-10 mx-auto p-4 bg-slate-200 rounded-md dark:bg-gray-900'>
                ...
                <div className='md:mx-5'>
                    <h1 className='text-2xl sm:text-4xl text-blue-600 mt-4 md:mt-0 md:font-normal md:text-4xl'>Master of Business Administration</h1>
                    <p className='md:text-xl my-2 dark:text-gray-400'>Hindusthan College of Arts & Science</p>
            ...
            <div className=' flex flex-col items-center md: md:flex-row w-fit my-10 mx-auto p-4 bg-slate-200 rounded-md dark:bg-gray-900'>
                ...
                <div className='md:mx-5'>
                    <h1 className='text-2xl sm:text-4xl text-blue-600 mt-4 md:mt-0 md:font-normal md:text-4xl'>Bachelor of Computer Applications</h1>
                    <p className='md:text-xl my-2 dark:text-gray-400'>Hindusthan College of Arts & Science</p>
